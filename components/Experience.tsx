    ...
    <div className='py-20' id='experience'>
        ...
        <div className='w-full mt-12 grid lg:grid-cols-4 grid-cols-1 gap-10'>
            {workExperience.map((card) => (
                <Button key={card.id} onClick={() => setIsTimelineOpen(true)} style={{ borderRadius: '1.75rem' }} duration={100000*card.id} className='flex-1 text-white border-neutral-200 dark:border-slate-800'>
        ...
        <Modal isOpen={isTimelineOpen} onClose={() => setIsTimelineOpen(false)} title="My Work Experience Timeline">
          <Timeline data={data} /> {/* Timeline Component */}
         </Modal>
        </div>
